...
# Send the arduino the current robot search control settings
def message_arduino(weeds, angle, watchdog):
    data = (
...
if __name__ == "__main__":
    while True:
        ...
        while time.time() - start_time < 5:
            # Code for loop 1
            message_arduino(WEEDS, ANGLE, WATCHDOG)
            print("Sent values:", WEEDS, ANGLE, WATCHDOG)
